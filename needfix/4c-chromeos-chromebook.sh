...
docker run -it -v ${cwd}:/root/kernelci-quickstart --name kernelci-build kernelci/clang-13 /root/kernelci-quickstart/scripts/build/build_chromeos_chromebook_stable_clang.sh
